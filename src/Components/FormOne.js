    ...
    return (
        <div className={style.form_container}>
            <form>
                ...
                <input className={style.name_input} type="text" id="fname" placeholder={placeholder1}></input>
                ...
                <Link to="Workspace"><button className={style.only_button} onClick={() => onSubmit(displayName)} >{buttonText}</button></Link>
            </form>
        </div>
    )
}
